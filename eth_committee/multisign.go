...
由委员会的leader发起
*/
func (com *EthCommittee) initMultiSign(tb *core.TimeBeacon, seed common.Hash, height uint64) *core.SignedTB {
	// 发送消息
...
func (com *EthCommittee) HandleMultiSignRequest(request *core.ComLeaderInitMultiSign) {
	seed := request.Seed
	tb := request.Tb
...
func (com *EthCommittee) HandleMultiSignReply(reply *core.MultiSignReply) {
